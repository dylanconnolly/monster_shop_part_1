  ...
  describe 'When I have added items to my cart' do
    describe 'and visit my cart path' do
      before(:each) do
        ...
        @paper = @mike.items.create(name: "Lined Paper", description: "Great for writing on!", price: 2000, image: "https://cdn.vertex42.com/WordTemplates/images/printable-lined-paper-wide-ruled.png", inventory: 25)

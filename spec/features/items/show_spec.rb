...
RSpec.describe 'item show page', type: :feature do
  before(:each) do
    ...
    @chain = @bike_shop.items.create(name: "Chain", description: "It'll never break!", price: 5000, image: "https://www.rei.com/media/b61d1379-ec0e-4760-9247-57ef971af0ad?size=784x588", inventory: 5)
  ...
  it 'shows item info' do
    ...
    expect(page).to have_content("Price: $#{@chain.price/100}")

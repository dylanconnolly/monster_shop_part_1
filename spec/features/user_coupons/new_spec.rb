...
RSpec.describe "users can use coupons" do
  describe "on the cart page the user sees a field to input a coupon code" do
    before(:each) do
      ...
      @paper = @mike.items.create(name: "Lined Paper", description: "Great for writing on!", price: 2000, image: "https://cdn.vertex42.com/WordTemplates/images/printable-lined-paper-wide-ruled.png", inventory: 3)
    ...
    it "the user can input a code and the system checks if there is a coupon code that matches" do
    ...
    it "if a user inputs a correct coupon code, they see a discounted total" do
      ...
      expect(page).to have_content("Discounted Total: $102")
    end
  end
end
